...
def run_algo(args, v, csize, G):
    if args.algo in ["alac_c", "alac_e"]:
        pred_cluster = run_alac(args, v, csize, G)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algo", default="alac_c", type=str, help="Algorithm name.")
